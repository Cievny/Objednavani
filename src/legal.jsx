...
export const VopPage = () => (
  <LegalShell title="Podmienky online objednávania na USG vyšetrenia">
    ...
    <OL>
      ...
      <LI>Pri vyšetrení so žiadankou od lekára hradí pacient doplatok podľa cenníka. Originál žiadanky (výmenného lístka) je pacient povinný predložiť pri vyšetrení; bez jej predloženia je pracovisko oprávnené účtovať plnú cenu samoplatcu alebo vyšetrenie nevykonať.</LI>
      ...
      <LI>Doklad o zaplatení vystaví poskytovateľ v súlade s platnými predpismi. <M>[DOPLNIŤ interný postup vystavovania dokladov]</M></LI>
    </OL>
